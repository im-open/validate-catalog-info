...
- Doc 3, Line 24, `System[content-management-3]/spec` is an object that cannot be empty. It may contain optional type, domain, and owner properties or be removed completely.
...
- Doc 8, Line 69, `System[content-management-8]/spec/type` value **service** is invalid
  - Allowed values: *bounded-context, product, *
